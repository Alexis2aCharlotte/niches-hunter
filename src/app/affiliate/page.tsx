          ...
          <LiquidCard className="p-8 text-center">
            ...
            <div className="relative">
              ...
              <div className="flex justify-between text-sm mb-2">
                ...
                <span className="text-white/30 line-through">$10/sale</span>
                <span className="text-[var(--primary)] font-bold">$14/sale</span>
                <span className="text-white/40">$18/sale</span>
              </div>
              
              {/* Bar background */}
              <div className="h-3 bg-white/10 rounded-full overflow-hidden">
                {/* 125 users sur 150 = 83% */}
                <div 
            ...
            <p className="text-xs text-white/40 mt-4">
              <span className="text-[var(--primary)] font-bold">125 users</span> already joined • Next commission increase at 150 users
            </p>
