      ...
      <section className="relative pt-32 pb-20 px-6 min-h-[80vh] flex items-center justify-center">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-purple-500/20 border border-purple-500/30 mb-8">
            ...
            <span className="text-sm font-bold text-purple-400 uppercase tracking-wider">Coming Soon</span>
          </div>
          ...
          <p className="text-lg text-white/50 max-w-xl mx-auto mb-10 leading-relaxed">
            Strategies, market analysis, and success stories to help you build profitable iOS apps. We're working hard to bring you quality content.
          </p>
