          ...
          <LiquidCard className="p-8 text-center">
            ...
            <div className="relative">
              ...
              <div className="h-3 bg-white/10 rounded-full overflow-hidden">
                {/* 61 users = premier palier (50) complété + 11 users sur le 2ème = ~41% */}
                <div 
            ...
            <p className="text-xs text-white/40 mt-4">
              <span className="text-[var(--primary)] font-bold">61 users</span> already joined • Next price increase at 100 users
            </p>
          </LiquidCard>
        </div>
      </section>
