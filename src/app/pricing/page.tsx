...
export default function PricingPage() {
  ...
  const features = {
    free: [
      { name: 'Daily newsletter', included: true },
      ...
      { name: 'TikTok Spot - Viral app trends', included: false },
      { name: 'AI Niche Validator', included: false },
      { name: 'Competitor deep-dive', included: false },
      { name: 'Save & track niches', included: false },
      { name: 'Priority support', included: false },
    ],
    pro: [
      { name: 'Daily newsletter', included: true },
      { name: '5 trending apps/day', included: true },
      { name: 'Full niche database access', included: true },
      { name: 'Niche Roulette', included: true },
      { name: 'Revenue Estimator', included: true },
      { name: 'Full niche analysis & insights', included: true },
      { name: 'TikTok Spot - Viral app trends', included: true },
      { name: 'AI Niche Validator (unlimited)', included: true },
      { name: 'Competitor deep-dive', included: true },
      { name: 'Save & track unlimited niches', included: true },
      ...
      <section className="relative px-6 pb-20">
        <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-6">
          ...
          <LiquidCard className="p-8 md:p-10 relative overflow-hidden">
            ...
            <Link
              href="/"
              className="block w-full py-4 text-center rounded-xl bg-white/10 text-white font-bold hover:bg-white/15 transition-all mb-8"
            >
              Get Started Free
            </Link>
          ...
          <LiquidCard className="p-8 md:p-10 relative overflow-hidden border-2 border-[var(--primary)]/30">
            ...
            <button
              ...
              className="block w-full py-4 text-center rounded-xl bg-[var(--primary)] text-black font-bold hover:bg-[#00E847] transition-all mb-8 shadow-[0_0_30px_rgba(0,204,61,0.3)] hover:shadow-[0_0_40px_rgba(0,204,61,0.5)] disabled:opacity-50"
            >
              {checkoutLoading ? (
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <LiquidCard className="overflow-hidden">
            <table className="w-full">
              ...
              <tbody>
                {[
                  { feature: 'Daily newsletter', free: '✓', pro: '✓' },
                  { feature: 'Trending apps per day', free: '5', pro: '5' },
                  { feature: 'Niche ideas access', free: 'Limited', pro: 'Unlimited' },
                  { feature: 'Niche Roulette', free: '✓', pro: '✓' },
                  { feature: 'Revenue Estimator', free: '✓', pro: '✓' },
                  { feature: 'Full niche analysis', free: '—', pro: '✓' },
                  { feature: 'TikTok Spot apps', free: '—', pro: '✓' },
                  { feature: 'AI Niche Validator', free: '—', pro: 'Unlimited' },
                  { feature: 'Competitor deep-dive', free: '—', pro: '✓' },
                  { feature: 'Save & track niches', free: '—', pro: 'Unlimited' },
