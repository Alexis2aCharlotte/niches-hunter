...
function TestimonialsSection() {
  ...
  const displayedTestimonials = isMobile && !showAllMobile 
    ...
    <section className="py-16 md:py-24 px-4 sm:px-6">
      <div className="text-center mb-12">
        ...
        <p className="text-base md:text-lg text-white/50 max-w-xl mx-auto mb-6">
          Join 117+ developers and entrepreneurs finding profitable niches with Niches Hunter
        </p>
        {/* Product Hunt Badge */}
        <a 
      ...
      {isMobile && !showAllMobile && testimonials.length > 4 && (
        <div className="mt-6 text-center">
          <button
            onClick={() => setShowAllMobile(true)}
            className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-white/5 border border-white/10 text-white/70 hover:text-white hover:bg-white/10 transition-all duration-200 text-sm font-medium"
          >
            See more reviews
          ...
          <div className="text-center lg:text-left z-10">
            ...
            <div className="mt-8 flex flex-wrap items-center justify-center lg:justify-start gap-x-4 gap-y-2 text-xs text-[rgba(255,255,255,0.6)] font-mono">
              <span className="flex items-center gap-1.5">
                ...
                <span className="font-bold text-white">117+</span> builders
              </span>
              <span className="flex items-center gap-1.5">
                <span className="text-[var(--primary)]">●</span>
            ...
            <div className="bg-[#050505] rounded-[22px] p-8 md:p-10 relative overflow-hidden" onClick={(e) => e.stopPropagation()}>
              ...
              <div className="mt-8 text-center">
                ...
                <p className="text-[10px] text-white/30">
                  Join <span className="text-white/60 font-medium">117+ indie devs</span> already hunting niches. <br />
